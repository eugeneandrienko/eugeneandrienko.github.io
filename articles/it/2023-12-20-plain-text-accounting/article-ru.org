...
#+CAPTION: Выбор стартовой даты для нового бюджета
#+ATTR_RST: :alt select start date :width 50% :align center
[[file:plan1.png]]

#+CAPTION: Ввод данных по накоплениям
#+ATTR_RST: :alt enter savings :width 50% :align center
[[file:plan2.png]]

#+CAPTION: Сумма пришедшей зарплаты, плюс остатки с предыдущей итерации
#+ATTR_RST: :alt enter salary :width 50% :align center
[[file:plan3.png]]

#+CAPTION: Составление бюджета
#+ATTR_RST: :alt budget drafting :width 50% :align center
[[file:plan4.png]]

#+CAPTION: Проверка того, что мы не ушли в минус
